...
import 'package:project9/admin/adminfront/admindashbaord.dart';
...
class AdminHomePage extends State<AdminHome>
{
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () async
      {
        Navigator.pushReplacement(context, PageRouteBuilder(pageBuilder: (a, b, c) => AdminDasboardScreen(),transitionDuration: Duration(seconds: 3)));
        return;
      },
      child: Scaffold(
